#ifndef GUARD_CONFIG_DYNAMAX_H
#define GUARD_CONFIG_DYNAMAX_H

// Allow Z-Moves in Dynamax Battles
#define DB_ALLOW_Z_MOVES FALSE
...
#define DB_ALLOW_OPPONENT_DYNAMAX FALSE

#endif // GUARD_CONFIG_DYNAMAX_H
