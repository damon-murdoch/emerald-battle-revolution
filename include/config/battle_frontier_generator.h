...
#define BFG_FORME_CHANCE_KYUREM 2 // Base Kyurem Sux
...
#define BFG_FORME_CHANCE_NECROZMA 1 // Base Necrozma Sux
...
#define BFG_FORME_CHANCE_CALYREX 1 // Base Calyrex Sux
