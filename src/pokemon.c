...
#define GFX_MANAGER_SPR_SIZE MON_PIC_SIZE // (MON_PIC_SIZE * 4) // * 4 is unnecessary, MON_PIC_SIZE is sufficient
#define GFX_MANAGER_NUM_FRAMES 2 // 4 // Only 2 frames are needed
