const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
...
#if P_GEN_9_POKEMON == TRUE
    [SPECIES_BASCULIN_WHITE_STRIPED] = {{EVO_ITEM, ITEM_LINKING_CORD, SPECIES_BASCULEGION_MALE},
    ...
    [SPECIES_BRAMBLIN]              = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_BRAMBLEGHAST}},
    [SPECIES_TOEDSCOOL]             = {{EVO_LEVEL, 30, SPECIES_TOEDSCRUEL}},
    [SPECIES_CAPSAKID]              = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_SCOVILLAIN}},
    [SPECIES_RELLOR]                = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_RABSCA}},
