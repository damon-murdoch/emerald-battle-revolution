...
const u8 gText_DefaultNameStu[] = _("Damon");
const u8 gText_DefaultNameMilton[] = _("Joseph");
const u8 gText_DefaultNameTom[] = _("Paulo");
const u8 gText_DefaultNameKenny[] = _("Henry");
const u8 gText_DefaultNameReid[] = _("Jackson");
const u8 gText_DefaultNameJude[] = _("James");
const u8 gText_DefaultNameJaxson[] = _("Luke");
const u8 gText_DefaultNameEaston[] = _("Sam");
const u8 gText_DefaultNameWalker[] = _("Daniel");
const u8 gText_DefaultNameTeru[] = _("Phil");
const u8 gText_DefaultNameJohnny[] = _("Jared");
const u8 gText_DefaultNameBrett[] = _("Harry");
const u8 gText_DefaultNameSeth[] = _("Jaden");
const u8 gText_DefaultNameTerry[] = _("Sean");
const u8 gText_DefaultNameCasey[] = _("Titan");
const u8 gText_DefaultNameDarren[] = _("Wolfe");
const u8 gText_DefaultNameLandon[] = _("Aaron");
const u8 gText_DefaultNameCollin[] = _("Markus");
const u8 gText_DefaultNameStanley[] = _("Jeaudy");
const u8 gText_DefaultNameQuincy[] = _("Sejun");
const u8 gText_DefaultNameKimmy[] = _("Lana");
const u8 gText_DefaultNameTiara[] = _("Ashe");
const u8 gText_DefaultNameBella[] = _("Teagan");
